 <div class="container-fluid">
      <div class="row-fluid">
        ...
        <div class="span9">
          ...
          <form action="/curriculo/cadastrar/formacao" id="frmCadastro" method="POST">
            <div class="well">
              <div>
                <h1>
                  Formação
                </h1>
                A formação é importante pois agrega valor a seu currículo. Você pode adicionar
                quantas quiser.
              </div>
              <div class="control-group">
                ...
                <select name="input-escolaridade">
                  <option value="ensino-fundamental">Ensino fundamental</option>
                  <option value="ensino-medio">Ensino médio</option>
                  <option value="ensino-superior-incompleto">Ensino superior incompleto</option>
                  <option value="ensino-superior-completo">Ensino superior completo</option>
                  <option value="pos-especializacao">Especialização</option>
                  <option value="MBA">MBA</option>
                  <option value="pos-mestrado">Mestrado</option>
                  <option value="pos-doutorado">Doutorado</option>
                </select>
                <div class="control-group">
                  <label for="textinput3">
                    Área:
                  </label>
                  <input name="input-area" type="text">
                </div>
                <div class="control-group">
                  <label for="textinput1">
                  início:
